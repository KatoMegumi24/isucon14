...
(
  ...
  -- 追加分
  total_distance            INT NOT NULL DEFAULT 0 COMMENT '累積走行距離',
  total_distance_updated_at DATETIME(6) NULL       COMMENT '累積距離更新日時',
...
CREATE INDEX chair_locations_id_created_at ON `chair_locations` (`chair_id`, `created_at` DESC);
...
CREATE INDEX ride_statuses_ride_id_app_sent_at_created_at ON `ride_statuses` (`ride_id`, `app_sent_at`, `created_at`);
